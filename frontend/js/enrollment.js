(function () {
  ...
  async function loadCourse() {
    try {
      const course = await window.CapacityApi.get(
      ...
      document.getElementById("startLearning").href =
        `lectures.html?course=${encodeURIComponent(course.id)}`;
      ...
      if (
        ...
        document.querySelector("#success p").firstChild.textContent =
